                ...
                <form method="post" action="{{ route('users.update', $user->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="firstname" id="firstname" class="form-input rounded-md shadow-sm mt-1 block w-full"
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="lastname" id="lastname" class="form-input rounded-md shadow-sm mt-1 block w-full"
